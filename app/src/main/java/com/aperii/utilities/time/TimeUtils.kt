...
object TimeUtils {
    ...
    fun getShortDateString(dateTimeSeconds: Long): String =
        SimpleDateFormat("MMMM yyyy", Locale.US).format(Date(dateTimeSeconds))
    ...
    fun getLongTimeString(dateTimeSeconds: Long): String =
        SimpleDateFormat("MM/dd/yyyy h:mma", Locale.US).format(Date(dateTimeSeconds))
